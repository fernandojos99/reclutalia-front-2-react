      ...
      <div style={{ display: "flex", gap: 16, alignItems: "center", marginBottom: 14 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 6, marginTop: 6, flexWrap: "wrap" }}>
            ...
            {/* El semáforo de movilidad ya NO se pinta aquí: vive en la pestaña "ficha", que es
                donde tiene contexto (desempeño, actas, antigüedad). Repetirlo suelto en la cabecera
                lo convertía en una etiqueta sobre la persona, sin nada que la explicara. */}
